...
Enter a US ZIP or lat,lon in the input and choose the number of days (e.g. 5).
Click "Generate".
Use the copy buttons to copy short caption, long caption, alt text, or image suggestions. Click the SVG download to get a ready-made overlay.
